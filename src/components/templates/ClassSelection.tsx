...
export default function ClassSelection({setDndClass}: {setDndClass: (dndClass: Class | null) => void}) {
    ...
    return(
        <main className="h-screen w-screen flex flex-col items-center text-white p-6 bg-[url(/background_scale.png)] bg-cover overflow-auto">
...

            {
                ...
                : 
                    <>
                        <ClassDetails dndClass={selectedClass!} handleClick={setSelectedClass}/>
                        <PrimaryButton 
                            onClick={() => { 
