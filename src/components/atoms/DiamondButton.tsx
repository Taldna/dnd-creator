export default function SquareButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={`w-12 h-12 flex items-center justify-center leading-none relative cursor-pointer ${
    ...
    >
      ...
      <span className="absolute inset-0 flex text-white items-center justify-center z-[60] pb-2">
        {name}
      </span>
    </button>
  )
