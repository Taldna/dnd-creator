        ...
        <Box className="size-4/5">
          <div className="flex gap-6 h-full">
            <div
              ...
              className="absolute top-5 right-5 bg-black/30 border-3 border-gray-500 rounded-full p-2 text-xl transition ease-in hover:scale-110 hover:bg-gray-800/60 z-20"
            >
